...
public:
    ...
    std::optional<MainMenuEvent> createAndDraw(pl::RenderTarget& window, pl::SpriteBatch& spriteBatch, Game& game, float dt, float applicationTime, bool steamInitialised);
